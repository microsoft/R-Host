        ...
        namespace ide {
            ...
            void ide_device::close() {
                ...
                rhost::host::with_cancellation([&] {
                    rhost::host::send_message(
                        "PlotDeviceDestroy",
                        rhost::util::to_utf8(device_name)
                    );
                });
            ...
            Rboolean ide_device::locator(double *x, double *y) {
                ...
                *y = 0;
                ...
                rhost::host::with_cancellation([&] {
                    auto device_name(boost::uuids::to_string(_device_id));
                    auto msg = rhost::host::send_message_and_get_response("Locator", rhost::util::to_utf8_json(device_name.c_str()));
                    auto args = msg.args;
            ...
            extern "C" SEXP ide_graphicsdevice_new(SEXP args) {
                ...
                return rhost::util::exceptions_to_errors([&] {
                    ...
                    rhost::host::with_cancellation([&] {
                        auto msg = rhost::host::send_message_and_get_response("PlotDeviceCreate", rhost::util::to_utf8_json(device_name.c_str()));
                        auto args = msg.args;
